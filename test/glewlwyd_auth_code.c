...
{
  char * url = msprintf("%s/auth?response_type=invalid&login_validated=true&client_id=client1_id&redirect_uri=../app/test-token.html&state=xyzabcd&scope=%s", SERVER_URI, SCOPE_LIST);
...
{
  char * url = msprintf("%s/auth?response_type=code&login_validated=true&client_id=client1_id&redirect_uri=../app/test-token.html&state=xyzabcd&scope=%s", SERVER_URI, SCOPE_LIST);
...
{
  char * url = msprintf("%s/auth?response_type=code&login_validated=true&client_id=client1_id&redirect_uri=../app/test-token.html?param=client1_cb1&state=xyz&scope=%s", SERVER_URI, SCOPE_LIST);
...
{
  char * url = msprintf("%s/auth?response_type=code&login_validated=true&client_id=client_error&redirect_uri=../app/test-token.html?param=client1_cb1&state=xyz&scope=%s", SERVER_URI, SCOPE_LIST);
...
{
  char * url = msprintf("%s/auth?response_type=code&login_validated=true&client_id=client_error&redirect_uri=../app/test-token.html?param=invalid&state=xyz&scope=%s", SERVER_URI, SCOPE_LIST);
  int res = run_simple_test(NULL, "GET", url, NULL, NULL, NULL, NULL, 302, NULL, NULL, "unauthorized_client");
  free(url);
	ck_assert_int_eq(res, 1);
}
...
{
  char * url = msprintf("%s/auth?response_type=code&login_validated=true&client_id=client1_id&redirect_uri=../app/test-token.html?param=client1_cb1&state=xyzabcd&scope=scope4", SERVER_URI);
